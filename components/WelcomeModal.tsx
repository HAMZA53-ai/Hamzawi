      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl max-w-lg w-full p-8 shadow-2xl animate-fade-in-up">
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 mb-6">
                مساعدك الذكي المدعوم من حمزاوي. استكشف قدرات الذكاء الاصطناعي المتقدمة عبر شخصيات متعددة.
            </p>

            <div className="space-y-4 text-start w-full mb-6">
             ...
             <div className="w-full mb-6">
                <label htmlFor="survey" className="block text-sm font-medium text-gray-300 mb-2 text-start">من أين سمعت عنا؟</label>
                <select id="survey" name="survey" className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5">
            ...
            <button
                onClick={onClose}
                className="w-full bg-purple-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-purple-700 transition-all focus:ring-4 focus:ring-purple-500/50"
            >
                ابدأ الآن
            </button>
        </div>
